...
object AppConfig {
    ...
    const val PREF_BLUR_BOTTOM_CORNER = "pref_blur_bottom_corner"
    const val PREF_BLUR_BOTTOM_REFRACTION_HEIGHT = "pref_blur_bottom_refraction_height"
    const val PREF_BLUR_BOTTOM_REFRACTION_OFFSET = "pref_blur_bottom_refraction_offset"
    const val PREF_BLUR_BOTTOM_BLUR_RADIUS = "pref_blur_bottom_blur_radius"
    const val PREF_BLUR_BOTTOM_DISPERSION = "pref_blur_bottom_dispersion"
    const val DEFAULT_BLUR_BOTTOM_CORNER = 40f
    const val DEFAULT_BLUR_BOTTOM_REFRACTION_HEIGHT = 20f
    const val DEFAULT_BLUR_BOTTOM_REFRACTION_OFFSET = 70f
    const val DEFAULT_BLUR_BOTTOM_BLUR_RADIUS = 0f
    const val DEFAULT_BLUR_BOTTOM_DISPERSION = 0.5f
